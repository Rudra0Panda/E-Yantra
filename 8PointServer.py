...
class WayPointServer(Node):
    def __init__(self):
        ...
        # PID gains
        self.Kp = [10, 8, 22.0, 0]
        self.Ki = [0.30, 0.35, 5.0, 0]
        self.Kd = [10, 14, 20.0, 0]
